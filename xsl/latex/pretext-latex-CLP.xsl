...
<xsl:template name="style-default-colours">
  <xsl:text>\definecolor{colour1}{HTML}{3B5F2B}</xsl:text>
  <xsl:text>\definecolor{colour2}{HTML}{00275F}</xsl:text>
...
<xsl:template match="assemblage" mode="tcb-style">
    <xsl:text>enhanced, boxrule=0.5pt, sharp corners, colback=colour1!50, colframe=colour1,&#xa;</xsl:text>
    <xsl:text>colbacktitle=colour1!50, coltitle=black, boxed title style={sharp corners, frame hidden},&#xa;</xsl:text>
