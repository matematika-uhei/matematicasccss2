...
<xsl:variable name="es-ES">
    ...
    <localization string-id='slide'><xsl:text>Diapositiva</xsl:text></localization> -->
    ...
    <localization string-id='backmatter'><xsl:text>Apéndices</xsl:text></localization> -->
    ...
    <localization string-id='table'><xsl:text>Tabla</xsl:text></localization>
